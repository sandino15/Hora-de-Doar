...
import com.example.gymfit2.databinding.ActivityMapsIheneBinding

class MapsIhene : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityMapsIheneBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityMapsIheneBinding.inflate(layoutInflater)
